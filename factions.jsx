...
const FACTIONS = [
  ...
  },
  {
    ...
    flavor: "Fewer hands on the trigger — every one of them carries a small star. Lattice shields. Phase blades. Weapons that rewrite the next ten seconds of the fight.",
    stats: [
      { k: 'ECONOMY', v: 50 },
      { k: 'TEMPO', v: 65 },
      { k: 'DURABILITY', v: 80 },
  ...
  },
  {
    ...
    code: 'F-03',
    name: 'HIVE',
    role: 'Swarm Supremacy',
    Icon: IconHive,
    color: 'oklch(0.78 0.18 145)',
    flavor: "A wave you hear before you see. Hive trades bodies for tempo. By the time you react, they are already inside your base.",
    stats: [
      { k: 'ECONOMY', v: 90 },
      { k: 'TEMPO', v: 95 },
      { k: 'DURABILITY', v: 30 },
